...
def create_data_lists(voc07_path, output_folder):
    ...
    test_objects = list()
    n_objects = 0
    voc07_path = '/home/rita/111/111-2DL/HW4/dataset/VOC2007/VOCdevkit/VOC2007_test'
...
def transform_seg(img, mask) :
    
    for i, j in zip(img, mask) :
        i = FT.to_tensor(cv2.resize(i, (300, 300)))
        j = FT.to_tensor(cv2.resize(j, (300, 300)))
        # i = cv2.resize(j, (300, 300))
        # j = cv2.resize(i, (300, 300))
